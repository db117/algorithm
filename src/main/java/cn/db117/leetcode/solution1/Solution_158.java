...
//给你一个文件
// file ，并且该文件只能通过给定的 read4 方法来读取，请实现一个方法使其能够使 read 读取 n 个字符。注意：你的 read 方法可能会被调用
//多次。 
//
// read4 的定义： 
//
...
/**
 * 158.用 Read4 读取 N 个字符 II.read-n-characters-given-read4-ii-call-multiple-times
 *
 * @author db117
 * @since 2023-08-04 16:39:58
 **/

public class Solution_158 {
    public static void main(String[] args) {
        Solution solution = new Solution_158().new Solution();
    }
