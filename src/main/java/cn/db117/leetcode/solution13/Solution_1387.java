...
// 
//
// Related Topics 记忆化搜索 动态规划 排序 👍 88 👎 0
 ...
 *
 * @author db117
 * @since 2024-12-22 21:20:36
 **/

public class Solution_1387 {
    public static void main(String[] args) {
        Solution solution = new Solution_1387().new Solution();
        // 12
        //			15
        //			2
//        System.out.println(solution.getKth(12, 15, 2));
        ...
        //			20
        //			5
        System.out.println(solution.getKth(10, 20, 5)); // 13
    }
    ...
    class Solution {
        ...
        public int getKth(int lo, int hi, int k) {
            ...
            // 按照权重排序
            Arrays.sort(arr, Comparator.comparingInt(Solution::dfs));
