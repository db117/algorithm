 ...
 *
 * @author db117
 * @since 2022-10-31 00:30:57
 **/

public class Solution_481 {
    public static void main(String[] args) {
        Solution solution = new Solution_481().new Solution();
    ...
    class Solution {
        public int magicalString(int n) {
            ...
            while (sb.length() < n) {
                // 添加次数
                int size = sb.charAt(index) - '0';

                sb.append(String.valueOf(isOne ? 1 : 2).repeat(Math.max(0, size)));
