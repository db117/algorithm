...
// 
//
// Related Topics 数组 哈希表 字符串 👍 29 👎 0
 ...
 *
 * @author db117
 * @since 2023-01-12 10:14:02
 **/

public class Solution_1807 {
    public static void main(String[] args) {
        Solution solution = new Solution_1807().new Solution();
    }
    ...
    class Solution {
        public String evaluate(String s, List<List<String>> knowledge) {
            ...
            while (i < n) {
                ...
                ans.append(map.getOrDefault(s.substring(start, i), "?"));
                i++;
            }
            return ans.toString();
        }
