 ...
 *
 * @author db117
 * @since 2023-09-03 23:22:56
 **/

public class Solution_1921 {
    public static void main(String[] args) {
        Solution solution = new Solution_1921().new Solution();
    }
    ...
    class Solution {
        public int eliminateMaximum(int[] dist, int[] speed) {
            ...
            int n = dist.length;
            // 距离 -> 索引
            PriorityQueue<int[]> pq = new PriorityQueue<>(Comparator.comparing(a -> (a[0] + speed[a[1]] - 1) / speed[a[1]]));// 向上取整,需要消耗的时间
