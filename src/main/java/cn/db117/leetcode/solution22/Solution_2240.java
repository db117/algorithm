 ...
 *
 * @author db117
 * @since 2023-09-01 11:15:44
 **/

public class Solution_2240 {
    public static void main(String[] args) {
        Solution solution = new Solution_2240().new Solution();
    }
    ...
    class Solution {
        public long waysToBuyPensPencils(int total, int cost1, int cost2) {
            long ans = 0;
            for (int i = 0; i <= total / cost1; i++) {// 钢笔数量
                int j = (total - i * cost1) / cost2;// 铅笔数量
                ans += j + 1;// 铅笔数量+1(0个也算)
            }
            return ans;
        }
