...
/**
 * 2522.将字符串分割成值不超过 K 的子字符串.partition-string-into-substrings-with-values-at-most-k
 *
 * @author db117
 * @since 2023-01-03 10:16:02
 **/

public class Solution_2522 {
    public static void main(String[] args) {
        Solution solution = new Solution_2522().new Solution();
    }
