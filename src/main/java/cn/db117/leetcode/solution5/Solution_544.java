...
// 
// n 的范围是 [2, 2¹²]. 
// 保证 n 可以写成 2ᵏ 的形式，其中 k 是正整数。 
// 
//
// 
//
// Related Topics 递归 字符串 模拟 👍 53 👎 0


package cn.db117.leetcode.solution5;

/**
 * 544.输出比赛匹配对.output-contest-matches
 *
 * @author db117
 * @since 2023-08-16 17:15:53
 **/

public class Solution_544 {
    public static void main(String[] args) {
        Solution solution = new Solution_544().new Solution();
    }
